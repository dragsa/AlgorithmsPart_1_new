...
//        StackOfStringsResizingArray stackOfStringsRA = new StackOfStringsResizingArray();
//        while (!in.isEmpty()) {
...
//        StackResizingArray<Integer> stackInstanceRA = new StackResizingArray<Integer>();
//        while (!in.isEmpty()) {
////            String s = in.readString();
...
//        StackOfStringsLinkedList stackOfStringsLL = new StackOfStringsLinkedList();
//        while (!in.isEmpty()) {
//            String s = in.readString();
//            if (s.equals("-")) {
